...
public class BasicDocument extends Document {
	 ...
	 */
	@Override
	//Return all words in text.//Return all words in text.
	public int getNumWords() {
		List<String> words = super.getTokens("[a-zA-z]+");
		//If there is no words in text, return 0.
		if(words.isEmpty()) {
			return 0;
		}
		int counter = 0;
	...
	public int getNumSentences(){
		List<String> sentencesLs = super.getTokens("[^.?!]+");
		//If there is no sentences, return 0.
		if(sentencesLs.isEmpty()) {
			return 0;
		}
		int counter = 0;
		for(String sentence : sentencesLs) {
			counter++;
		}
		return counter;
	}
	 ...
	 */
	//Return the number of syllables on a text.
	@Override
